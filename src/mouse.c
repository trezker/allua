...
{
   allua_set_event_callback(ALLEGRO_EVENT_MOUSE_AXES,
                            allua_mouse_event_callback);
   allua_set_event_callback(ALLEGRO_EVENT_MOUSE_BUTTON_DOWN,
                            allua_mouse_event_callback);
   allua_set_event_callback(ALLEGRO_EVENT_MOUSE_BUTTON_UP,
                            allua_mouse_event_callback);
   allua_set_event_callback(ALLEGRO_EVENT_MOUSE_ENTER_DISPLAY,
                            allua_mouse_event_callback);
   allua_set_event_callback(ALLEGRO_EVENT_MOUSE_LEAVE_DISPLAY,
                            allua_mouse_event_callback);
