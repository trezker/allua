...
{
   allua_set_event_callback(ALLEGRO_EVENT_KEY_DOWN,
                            allua_keyboard_event_callback);
   allua_set_event_callback(ALLEGRO_EVENT_KEY_CHAR,
                            allua_keyboard_event_callback);
   allua_set_event_callback(ALLEGRO_EVENT_KEY_UP,
                            allua_keyboard_event_callback);
