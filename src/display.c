...
{
   allua_set_event_callback(ALLEGRO_EVENT_DISPLAY_RESIZE,
                            allua_display_event_callback);
   allua_set_event_callback(ALLEGRO_EVENT_DISPLAY_CLOSE,
                            allua_display_event_callback);
